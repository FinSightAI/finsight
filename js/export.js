...
<div class="page-wrapper">
    ...
    <div class="report-footer">
        ${((I18n && I18n.t) ? I18n.t('report.footer') : 'Report generated by WizeMoney')} &bull; ${dateStr}
    </div>
</div>
<script>
    ...
    generateFullReport() {
        ...
        // ── Report label resolver (4-language via I18n) ──
        const t = key => (I18n && I18n.t) ? I18n.t('report.' + key) : key;
        ...
        <div class="hero-header">
            <div class="brand-row">
                ...
                <div>
                    <div class="brand-name">WizeMoney</div>
                    <div class="brand-tagline">${t('tagline')}</div>
                </div>
            </div>
            <div class="hero-meta">${t('generated')} &bull; ${dateStr}</div>
        ...
        if (assetsData.length > 0) {
            ...
            content += section('🏠',
                ...
                `<table>
                    <thead><tr>
                        <th>${t('colAssetName')}</th>
                        <th>${t('colType')}</th>
                        <th>${t('colEstimatedValue')}</th>
                    </tr></thead>
                    <tbody>${rows}</tbody>
                    <tfoot><tr>
                        <td colspan="2">${t('total')}</td>
            ...
            content += section('🏦',
                ...
                `<table>
                    <thead><tr>
                        ...
                        <th>${t('colMonthlyPayment')}</th>
                        <th>${t('colInterestRate')}</th>
                    </tr></thead>
                    <tbody>${rows}</tbody>
                    <tfoot><tr>
                        <td>${t('total')}</td>
        ...
        <div class="section">
            <div class="section-header">
                ...
                <div class="section-title">${t('netWorthSummary')}</div>
            </div>
            <div class="networth-summary">
                <div class="networth-row">
                    <span class="nw-label">${t('bankAccounts')}</span>
                    <span class="nw-value">${fmt(bankTotal)}</span>
                </div>
                <div class="networth-row">
                    <span class="nw-label">${t('stockPortfolio')}</span>
                    <span class="nw-value">${fmt(stocksTotal)}</span>
                </div>
                <div class="networth-row">
                    <span class="nw-label">${t('savingsFunds')}</span>
                    <span class="nw-value">${fmt(fundsTotal)}</span>
                </div>
                <div class="networth-row">
                    <span class="nw-label">${t('assets')}</span>
